                    ...
                    todos.map((todo) =>(
                        ...
                        <li key={todo.id}>
                            ...
                            <div className='buttons'>
                                <button className="complete" onClick={() => handleComplete(todo)}><i className="fa-solid fa-circle-check"></i></button>
                                <button className='edit' onClick={() => handleEdit(todo.id)}><i className="fa-regular fa-pen-to-square"></i></button>
                                <button className='remove' onClick={() => delteTodo(todo.id)}><i className="fa-solid fa-trash"></i></button>
                            </div>
                        </li>:""
                    ))}
                </div>    
